      ...
      <div class="element-box">
        {!! Form::open(array('route' => 'LitterInspections.store','method'=>'POST')) !!}
          ...
          @if(in_array($user->user_type_id, $allowed_users))
              <select class="form-control select2 selectpicker dynamicbreeder dynamicdam" data-live-search="true" id="breeder_id" name="breeder_id" data-dependent="dam_id">
          ...
          @else
              <select class="form-control select2 selectpicker" data-live-search="true" name="breeder_id">
