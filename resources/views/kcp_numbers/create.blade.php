            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="">Start Range:<span class="text-danger">*</span></label><input class="form-control" name="start_range" data-error="Please input your Start Range" placeholder="" required="required" type="text">
                  <div class="help-block form-text with-errors form-control-feedback"></div>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  <label for="">End Range:<span class="text-danger">*</span></label><input class="form-control" name="end_range" data-error="Please input your End Range" placeholder="" required="required" type="text">
                  <div class="help-block form-text with-errors form-control-feedback"></div>
                </div>
              </div>
            </div>
