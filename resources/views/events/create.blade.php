  ...
  <div class="col-lg-12">
    <div class="element-wrapper">
      ...
      <div class="element-box">
        <form action="{{ route('Event.store') }}" method="POST" id="formValidate" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container" id="myDIV">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              ...
              <input id="title" name="title" class="form-control" data-error="Please fill title" placeholder="Enter title here" required="required" type="text" onkeyup="Friendly_URLFunction()">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <div class="date-input">
                <input class="single-daterange form-control" id="start_date" name="start_date" type="text">
              </div>
            </div>
            <div class="col-sm-2"><span class="text-danger h4" data-toggle="tooltip" data-placement="top" 
            title="required"> *</span></div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <div class="date-input">
                <input class="single-daterange form-control" id="end_date" name="end_date" type="text">
              </div>
            </div>
            <div class="col-sm-2"><span class="text-danger h4" data-toggle="tooltip" data-placement="top" 
            title="required"> *</span></div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <div class="date-input">
                <input class="single-daterange form-control" id="last_date_of_entry" name="last_date_of_entry" type="text">
              </div>
            </div>
            <div class="col-sm-2"><span class="text-danger h4" data-toggle="tooltip" data-placement="top" 
            title="required"> *</span></div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input class="form-control" name="venue" id="venue" placeholder="Enter venue here" type="text">
            </div>
            <div class="col-sm-2"></div>
          </div>
          <hr>
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input class="form-control" name="judge" id="judge" placeholder="Enter Judges name here" type="text">
            </div>
            <div class="col-sm-2">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-3">
              <input class="form-control" name="fee" id="fee" placeholder="Enter fee here" type="text">
            </div>
            <div class="col-sm-2"></div>
          </div>
          <hr>
